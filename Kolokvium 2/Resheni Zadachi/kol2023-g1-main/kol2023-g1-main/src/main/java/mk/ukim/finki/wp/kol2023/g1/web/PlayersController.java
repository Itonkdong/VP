...
public class PlayersController
{
    ...
    )
    {
        ...
        List<PlayerPosition> playerPositions = Arrays.stream(PlayerPosition.values()).collect(Collectors.toList());
    ...
    {
        List<Team> teams = this.teamService
                .listAll();
    ...
    {
        Player delete = this.playerService.delete(id);
