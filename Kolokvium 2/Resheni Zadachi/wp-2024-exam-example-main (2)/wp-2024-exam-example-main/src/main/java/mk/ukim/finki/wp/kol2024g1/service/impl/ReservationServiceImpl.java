...
import mk.ukim.finki.wp.kol2024g1.service.FieldFilterSpecification;
...
public class ReservationServiceImpl implements ReservationService
{
    ...
    public Page<Reservation> findPage(String guestName, RoomType roomType, Long hotel, int pageNum, int pageSize)
    {
        Specification<Reservation> specification = Specification
                .where(FieldFilterSpecification.filterContainsText(Reservation.class, "guestName", guestName))
        ...
        return this.reservationRepository
                .findAll(specification, PageRequest.of(pageNum, pageSize));
    }
}
