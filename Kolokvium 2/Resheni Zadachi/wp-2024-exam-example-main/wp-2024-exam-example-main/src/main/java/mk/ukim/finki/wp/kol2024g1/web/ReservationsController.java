...
public class ReservationsController
{
    ...
    )
    {
        ...
        Page<Reservation> page = this.reservationService
                .findPage(guestName, roomType, hotel, pageNum - 1, pageSize);
    ...
    {
        Reservation reservation = this.reservationService
                .create(guestName, dateCreated, daysOfStay, roomType, hotelId);
    ...
    {
        Reservation reservation = this.reservationService
                .update(id, guestName, dateCreated, daysOfStay, roomType, hotelId);
